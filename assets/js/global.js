    ...
    const countryGlob = document.getElementById('countryGlob'),
          allCasesGlob = document.getElementById('allCasesGlob'),
          newCasesGlob = document.getElementById('newCasesGlob'),
          newDeathGlob = document.getElementById('newDeathGlob'),
          allRecoveredGlob = document.getElementById('allRecoveredGlob'),
          nowCaseGlob = document.getElementById('nowCaseGlob'),
          allDeathGlob = document.getElementById('allDeathGlob'),
          allCriticalGlob = document.getElementById('allCriticalGlob');
